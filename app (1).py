...
class ReportGenerator:
    ...
    def txt(self) -> str:
        ...
        lines = [
            ...
            f'  FS events logged     : {stats["fs_total"]}',
            ...
            '  Step 1  File Events Logging   ✓ SQLite audit trail',
...
def page_dashboard():
    ...
    if events:
        ...
        st.info('No filesystem events yet.')
...
def page_send_file():
    ...
    with col1:
        ...
        dest = st.text_input(
            'Destination Folder',
            value='',
            placeholder='e.g. C:\\Users\\You\\Downloads or /home/user/files',
            help='Enter the full path of the folder where the file will be saved')
...
def page_settings():
    ...
    features = [
        '✓  Step 1: SQLite audit trail for all file events',
